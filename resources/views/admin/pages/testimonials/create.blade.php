                                ...
                                <div class="col-12">
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="comment" id="addSummernote" class="form-control summernote" placeholder="Comment"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Review Start</label>
                                            <input type="number" name="review"
                                                class="form-control" id="exampleInputName1"
                                                placeholder="Review Start" value="5" required max="5">
                                        </div>
                                        <div class="form-group">
