                            ...
                            <tbody>
                                @forelse ($services as $service)
                                    <tr class="text-center">
                                        ...
                                        <td class="py-1">
                                            <img src="{{ asset('/storage/admin/assets/images/service/'.$service->icon_image) }}"
                                                alt="image" />
                                        </td>
                                        <td class="py-1">
                                            @if ($service->type == 'image')
                                                <img src="{{ asset('/storage/admin/assets/images/service/' . $service->image_video) }}"
                                                    alt="image" />
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="">
                                                                        <div class="form-group">
                                                                            <label for="exampleInputName1">Service
                                                                                Category</label>
                                                                            <select class="form-select"
                                                                                ...
                                                                                @foreach ($serviceCategories as $serviceCategory)
                                                                                    <option
                                                                                        ...
                                                                                        @if ($serviceCategory->id == $service->service_category_id) selected @endif>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="description" id="" class="form-control editsummernote" placeholder="Description" required>{!! $service->description !!}</textarea>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-select" name="is_active"
                                                                                id="exampleFormControlSelect2">
                                                                                <option value="1"
                                                                                    @if ($service->is_active == true) selected @endif>
                                                                                    Active</option>
                                                                                <option value="0"
                                                                                    @if ($service->is_active == false) selected @endif>
                                                                                    Inactive</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="">
                                    <div class="form-group">
                                        <label for="exampleInputName1">Service Category</label>
...
@push('admin_scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('button[id^="serviceDeleteButton-"]').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $('#serviceDeleteForm-' + serviceId).submit();
                    }
                });
            });
